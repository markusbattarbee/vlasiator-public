      ...
      for (auto const dccrgCell : snd.second) {
         ...
         for (auto const fsgridCell : fsgridCells) {
            ...
            sendBuffer[ii].sums[FieldsToCommunicate::dVxdx] +=
                dMomentscell->at(fsgrids::dmoments::dVxdx) / technicalGrid.DX;
            sendBuffer[ii].sums[FieldsToCommunicate::dVxdy] +=
                dMomentscell->at(fsgrids::dmoments::dVxdy) / technicalGrid.DY;
            sendBuffer[ii].sums[FieldsToCommunicate::dVxdz] +=
                dMomentscell->at(fsgrids::dmoments::dVxdz) / technicalGrid.DZ;
            sendBuffer[ii].sums[FieldsToCommunicate::dVydx] +=
                dMomentscell->at(fsgrids::dmoments::dVydx) / technicalGrid.DX;
            sendBuffer[ii].sums[FieldsToCommunicate::dVydy] +=
                dMomentscell->at(fsgrids::dmoments::dVydy) / technicalGrid.DY;
            sendBuffer[ii].sums[FieldsToCommunicate::dVydz] +=
                dMomentscell->at(fsgrids::dmoments::dVydz) / technicalGrid.DZ;
            sendBuffer[ii].sums[FieldsToCommunicate::dVzdx] +=
                dMomentscell->at(fsgrids::dmoments::dVzdx) / technicalGrid.DX;
            sendBuffer[ii].sums[FieldsToCommunicate::dVzdy] +=
                dMomentscell->at(fsgrids::dmoments::dVzdy) / technicalGrid.DY;
            sendBuffer[ii].sums[FieldsToCommunicate::dVzdz] +=
                dMomentscell->at(fsgrids::dmoments::dVzdz) / technicalGrid.DZ;
