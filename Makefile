...
DEPS_GPU_OPEN_ACC_MAP_CUDA = ${DEPS_CPU_VECTORCLASS_FALLBACK} vlasovsolver/vec.h vlasovsolver_cuda/cuda_header.cuh vlasovsolver_cuda/open_acc_map_h.cuh vlasovsolver_cuda/open_acc_map_cuda.cu vlasovsolver_cuda/*
...
open_acc_map_cuda.o: ${DEPS_GPU_OPEN_ACC_MAP_CUDA}
	${NVCC}   ${CUDAFLAGS} -D${VECTORCLASS} -c vlasovsolver_cuda/open_acc_map_cuda.cu
