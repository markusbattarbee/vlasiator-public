...
// associated with
template <class T>
std::array<FsGridTools::FsSize_t, 3> getGlobalFsGridCellIndexForCoord(T& grid, const std::array<Real, 3>& x) {
...
template <class T>
std::array<FsGridTools::FsIndex_t, 3> getLocalFsGridCellIndexForCoord(T& grid, const std::array<Real, 3>& x) {
...
template <class T>
std::array<FsGridTools::FsIndex_t, 3> getLocalFsGridCellIndexWithGhostsForCoord(T& grid, const std::array<Real, 3>& x) {
   std::array<FsGridTools::FsSize_t, 3> globalInd = getGlobalFsGridCellIndexForCoord(grid, x);
   const std::array<FsGridTools::FsIndex_t, 3> localStart = grid.getLocalStart();
   std::array<FsGridTools::FsIndex_t, 3> retval = {(FsGridTools::FsIndex_t)globalInd[0] - localStart[0],
                                                   (FsGridTools::FsIndex_t)globalInd[1] - localStart[1],
...
bool traceFullFieldFunction(FsGrid<std::array<Real, fsgrids::bfield::N_BFIELD>, FS_STENCIL_WIDTH>& perBGrid,
   ...
   std::array<FsGridTools::FsSize_t, 3> fsgridCellu =
       getGlobalFsGridCellIndexForCoord(technicalGrid, {(TReal)r[0], (TReal)r[1], (TReal)r[2]});
   std::array<FsGridTools::FsIndex_t, 3> fsgridCell = {(FsGridTools::FsIndex_t)fsgridCellu[0],
                                                       (FsGridTools::FsIndex_t)fsgridCellu[1],
                                                       (FsGridTools::FsIndex_t)fsgridCellu[2]};
